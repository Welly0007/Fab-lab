        ...
        (function($) {
            var slide = function(ele,options) {
                ...
                var states = [
                    ...
                    { $zIndex: 8, width: 0, height: 0, top: 198, left: -500, $opacity: 0.5 },
                    { $zIndex: 9, width: 200, height: 300, top: 50, left: 0, $opacity: 0.8 },
                    { $zIndex: 10, width: 281, height: 375, top: 0, left: 245, $opacity: 1 },
                    { $zIndex: 9, width: 200, height: 300, top: 50, left: 558, $opacity: 0.8 },
                    { $zIndex: 8, width: 0, height: 0, top: 198, left: 1058, $opacity: 0.5 },
                    // { $zIndex: 6, width: 0, height: 0, top: 79, left: 500, $opacity: 0 },
                    // { $zIndex: 5, width: 0, height: 0, top: 79, left: 700, $opacity: 0 },
                    // { $zIndex: 4, width: 0, height: 0, top: 79, left: 700, $opacity: 0 },
                    // { $zIndex: 3, width: 0, height: 0, top: 79, left: 700, $opacity: 0 },
